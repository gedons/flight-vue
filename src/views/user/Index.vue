<template>
  ...
  <div id="main-wrapper">
      ...
      <div class="container">
        <nav id="navigation" class="navigation navigation-landscape">
          <div class="nav-header">
            <a class="nav-brand" href="#"><img src="/src/assets/img/logo.png" class="logo" alt=""></a>
              ...
              <ul>
                ...
                <li class="languageDropdown me-2">
                  <a href="#" class="nav-link" data-bs-toggle="modal" data-bs-target="#countryModal"><img
                      src="/src/assets/img/flag/flag.png" class="img-fluid" width="17" alt="Country"></a>
                </li>
                <li>
          ...
          <div class="nav-menus-wrapper" style="transition-property: none;">
            ...
            <li><a href="documantion/index.html" target="_blank">Contact </a></li>
    ...
    <!-- ============================ Hero Banner  Start================================== -->
    <div class="image-cover hero-header bg-white" style="background:url(/src/assets/img/banner.jpg)no-repeat;"
      data-overlay="5">
      <div class="container">
        ...
        <div class="row justify-content-center align-items-center">
          <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12">
            <div class="position-relative text-center mb-5">
              <h1>Starts Your Trip with <span class="position-relative z-4">FcTrip<span
      ...
      <div class="container">
        ...
        <div class="row justify-content-center gy-4 gx-3">
          ...
          <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
            <div class="destination-blocks bg-white p-2 rounded border br-dashed h-100">
              <div class="destination-blocks-pics p-1">
                <a href="#"><img src="/src/assets/img/city/c-8.png" class="img-fluid rounded" alt=""></a>
              </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
            <div class="destination-blocks bg-white p-2 rounded border br-dashed h-100">
              <div class="destination-blocks-pics p-1">
                <a href="#"><img src="/src/assets/img/city/c-7.png" class="img-fluid rounded" alt=""></a>
              </div>
              <div class="destination-blocks-captions">
                <div class="touritem-flexxer text-center p-3">
                  <h4 class="city fs-5 m-0 fw-bold">
          ...
          <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
            <div class="destination-blocks bg-white p-2 rounded border br-dashed h-100">
              <div class="destination-blocks-pics p-1">
                <a href="#"><img src="/src/assets/img/city/c-1.png" class="img-fluid rounded" alt=""></a>
              </div>
              <div class="destination-blocks-captions">
                <div class="touritem-flexxer text-center p-3">
                  <h4 class="city fs-5 m-0 fw-bold">
          ...
          <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
            <div class="destination-blocks bg-white p-2 rounded border br-dashed h-100">
              <div class="destination-blocks-pics p-1">
                <a href="#"><img src="/src/assets/img/city/c-2.png" class="img-fluid rounded" alt=""></a>
              </div>
              <div class="destination-blocks-captions">
                <div class="touritem-flexxer text-center p-3">
                  <h4 class="city fs-5 m-0 fw-bold">
          ...
          <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
            <div class="destination-blocks bg-white p-2 rounded border br-dashed h-100">
              <div class="destination-blocks-pics p-1">
                <a href="#"><img src="/src/assets/img/city/c-3.png" class="img-fluid rounded" alt=""></a>
              </div>
              <div class="destination-blocks-captions">
                <div class="touritem-flexxer text-center p-3">
                  <h4 class="city fs-5 m-0 fw-bold">
          ...
          <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
            <div class="destination-blocks bg-white p-2 rounded border br-dashed h-100">
              <div class="destination-blocks-pics p-1">
                <a href="#"><img src="/src/assets/img/city/c-4.png" class="img-fluid rounded" alt=""></a>
              </div>
              <div class="destination-blocks-captions">
                <div class="touritem-flexxer text-center p-3">
                  <h4 class="city fs-5 m-0 fw-bold">
          ...
          <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
            <div class="destination-blocks bg-white p-2 rounded border br-dashed h-100">
              <div class="destination-blocks-pics p-1">
                <a href="#"><img src="/src/assets/img/city/c-5.png" class="img-fluid rounded" alt=""></a>
              </div>
              <div class="destination-blocks-captions">
                <div class="touritem-flexxer text-center p-3">
                  <h4 class="city fs-5 m-0 fw-bold">
          ...
          <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
            <div class="destination-blocks bg-white p-2 rounded border br-dashed h-100">
              <div class="destination-blocks-pics p-1">
                <a href="#"><img src="/src/assets/img/city/c-6.png" class="img-fluid rounded" alt=""></a>
              </div>
              <div class="destination-blocks-captions">
                <div class="touritem-flexxer text-center p-3">
                  <h4 class="city fs-5 m-0 fw-bold">
              ...
              <a href="#" class="card rounded-3 shadow-wrap h-100 m-0">
                <div class="flight-thumb-wrapper">
                  ...
                  <div class="popFlights-item-overHidden">
                    <img src="/src/assets/img/destination/tr-1.jpg" class="img-fluid" alt="">
                  </div>
                </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="pop-touritem">
              <a href="#" class="card rounded-3 shadow-wrap h-100 m-0">
                <div class="flight-thumb-wrapper">
                  <div class="popFlights-item-overHidden">
                    <img src="/src/assets/img/destination/tr-2.jpg" class="img-fluid" alt="">
                  </div>
                </div>
                <div class="touritem-middle position-relative p-3">
                  <div class="touritem-flexxer">
            ...
            <div class="pop-touritem">
              <a href="#" class="card rounded-3 shadow-wrap h-100 m-0">
                <div class="flight-thumb-wrapper">
                  ...
                  <div class="popFlights-item-overHidden">
                    <img src="/src/assets/img/destination/tr-3.jpg" class="img-fluid" alt="">
                  </div>
                </div>
                <div class="touritem-middle position-relative p-3">
                  <div class="touritem-flexxer">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="pop-touritem">
              <a href="#" class="card rounded-3 shadow-wrap h-100 m-0">
                <div class="flight-thumb-wrapper">
                  <div class="popFlights-item-overHidden">
                    <img src="/src/assets/img/destination/tr-4.jpg" class="img-fluid" alt="">
                  </div>
                </div>
                <div class="touritem-middle position-relative p-3">
                  <div class="touritem-flexxer">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="pop-touritem">
              <a href="#" class="card rounded-3 shadow-wrap h-100 m-0">
                <div class="flight-thumb-wrapper">
                  <div class="popFlights-item-overHidden">
                    <img src="/src/assets/img/destination/tr-5.jpg" class="img-fluid" alt="">
                  </div>
                </div>
                <div class="touritem-middle position-relative p-3">
                  <div class="touritem-flexxer">
            ...
            <div class="pop-touritem">
              <a href="#" class="card rounded-3 shadow-wrap h-100 m-0">
                <div class="flight-thumb-wrapper">
                  ...
                  <div class="popFlights-item-overHidden">
                    <img src="/src/assets/img/destination/tr-10.jpg" class="img-fluid" alt="">
                  </div>
                </div>
                <div class="touritem-middle position-relative p-3">
                  <div class="touritem-flexxer">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="pop-touritem">
              <a href="#" class="card rounded-3 shadow-wrap h-100 m-0">
                <div class="flight-thumb-wrapper">
                  <div class="popFlights-item-overHidden">
                    <img src="/src/assets/img/destination/tr-9.jpg" class="img-fluid" alt="">
                  </div>
                </div>
                <div class="touritem-middle position-relative p-3">
                  <div class="touritem-flexxer">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="pop-touritem">
              <a href="#" class="card rounded-3 shadow-wrap h-100 m-0">
                <div class="flight-thumb-wrapper">
                  <div class="popFlights-item-overHidden">
                    <img src="/src/assets/img/destination/tr-6.jpg" class="img-fluid" alt="">
                  </div>
                </div>
                <div class="touritem-middle position-relative p-3">
                  <div class="touritem-flexxer">
        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-xl-5 col-lg-5 col-md-12 position-relative pe-xl-5 pe-lg-4 pe-md-4 pb-xl-5 pb-lg-4 pb-md-4">
            <div class="position-relative mb-lg-0 mb-4">
              <img src="/src/assets/img/img-3.jpg" class="img-fluid rounded-3 position-relative z-1" alt="">
                  ...
                  <div class="me-4">
                    ...
                    <ul class="avatar-group mb-0">
                      <li class="avatar avatar-md">
                        <img class="avatar-img circle" src="/src/assets/img/team-1.jpg" alt="avatar">
                      </li>
                      <li class="avatar avatar-md">
                        <img class="avatar-img circle" src="/src/assets/img/team-2.jpg" alt="avatar">
                      </li>
                      <li class="avatar avatar-md">
                        <img class="avatar-img circle" src="/src/assets/img/team-3.jpg" alt="avatar">
                      </li>
                      <li class="avatar avatar-md">
                        <img class="avatar-img circle" src="/src/assets/img/team-4.jpg" alt="avatar">
                      </li>
                      <li class="avatar avatar-md">
    ...
    <!-- ============================ Video Helps End ================================== -->
    <section class="bg-cover" style="background:url(/src/assets/img/bg-3.jpg)no-repeat;" data-overlay="5">
            ...
            <div class="card border-0 rounded-3">
              <div class="card-body">
                ...
                <div class="d-flex align-items-center flex-thumbes">
                  <div class="revws-pic"><img src="/src/assets/img/team-1.jpg" class="img-fluid rounded-2" width="80" alt="">
                  </div>
              ...
              <div class="card-body">
                <div class="position-absolute top-0 end-0 mt-3 me-3"><span
                    class="square--40 circle text-primary bg-light-primary"><i
                      class="fa-solid fa-quote-right"></i></span></div>
                <div class="d-flex align-items-center flex-thumbes">
                  <div class="revws-pic"><img src="/src/assets/img/team-2.jpg" class="img-fluid rounded-2" width="80" alt="">
                  </div>
                  <div class="revws-caps ps-3">
              ...
              <div class="card-body">
                <div class="position-absolute top-0 end-0 mt-3 me-3"><span
                    class="square--40 circle text-primary bg-light-primary"><i
                      class="fa-solid fa-quote-right"></i></span></div>
                <div class="d-flex align-items-center flex-thumbes">
                  <div class="revws-pic"><img src="/src/assets/img/team-3.jpg" class="img-fluid rounded-2" width="80" alt="">
                  </div>
                  <div class="revws-caps ps-3">
              ...
              <div class="card-body">
                <div class="position-absolute top-0 end-0 mt-3 me-3"><span
                    class="square--40 circle text-primary bg-light-primary"><i
                      class="fa-solid fa-quote-right"></i></span></div>
                <div class="d-flex align-items-center flex-thumbes">
                  <div class="revws-pic"><img src="/src/assets/img/team-4.jpg" class="img-fluid rounded-2" width="80" alt="">
                  </div>
                  <div class="revws-caps ps-3">
              ...
              <div class="card-body">
                <div class="position-absolute top-0 end-0 mt-3 me-3"><span
                    class="square--40 circle text-primary bg-light-primary"><i
                      class="fa-solid fa-quote-right"></i></span></div>
                <div class="d-flex align-items-center flex-thumbes">
                  <div class="revws-pic"><img src="/src/assets/img/team-5.jpg" class="img-fluid rounded-2" width="80" alt="">
                  </div>
                  <div class="revws-caps ps-3">
      ...
      <div class="container">
        ...
        <div class="row justify-content-center g-4">
          ...
          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
            <div class="blogGrid-wrap d-flex flex-column h-100">
              <div class="blogGrid-pics">
                <a href="#" class="d-block"><img src="/src/assets/img/blog-1.jpg" class="img-fluid rounded"
                    alt="Blog image"></a>
              </div>
          ...
          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
            <div class="blogGrid-wrap d-flex flex-column h-100">
              <div class="blogGrid-pics">
                <a href="#" class="d-block"><img src="/src/assets/img/blog-2.jpg" class="img-fluid rounded"
                    alt="Blog image"></a>
              </div>
              <div class="blogGrid-caps pt-3">
                <div class="d-flex align-items-center mb-1"><span
          ...
          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
            <div class="blogGrid-wrap d-flex flex-column h-100">
              <div class="blogGrid-pics">
                <a href="#" class="d-block"><img src="/src/assets/img/blog-3.jpg" class="img-fluid rounded"
                    alt="Blog image"></a>
              </div>
              <div class="blogGrid-caps pt-3">
                <div class="d-flex align-items-center mb-1"><span
            ...
            <div class="col-lg-3 col-md-4">
              <div class="footer-widget">
                <div class="d-flex align-items-start flex-column mb-3">
                  <div class="d-inline-block"><img src="/src/assets/img/logo.png" class="img-fluid" width="160"
                      alt="Footer Logo">
                  </div>
                </div>
                ...
                <div class="our-prtwrap mt-4">
                  ...
                  <div class="prtn-thumbs d-flex align-items-center justify-content-start">
                    <div class="pmt-wrap pe-4">
                      <img src="/src/assets/img/mytrip.png" class="img-fluid" alt="">
                    </div>
                    <div class="pmt-wrap pe-4">
                      <img src="/src/assets/img/tripadv.png" class="img-fluid" alt="">
                    </div>
                    <div class="pmt-wrap pe-4">
                      <img src="/src/assets/img/goibibo.png" class="img-fluid" alt="">
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <ul
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/united-states.png"
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/united-kingdom.png"
                            class="img-fluid circle" width="35" alt=""></div>
                    ...
                    <li class="col">
                      <a class="selectCountry active" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/flag.png" class="img-fluid circle"
                            width="35" alt=""></div>
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/belgium.png" class="img-fluid circle"
                            width="35" alt=""></div>
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/brazil.png" class="img-fluid circle"
                            width="35" alt=""></div>
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/china.png" class="img-fluid circle"
                            width="35" alt=""></div>
              ...
              <div class="suggestedCurrencylist-wrap">
                ...
                <div class="suggestedCurrencylists">
                  <ul
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/vietnam.png" class="img-fluid circle"
                            width="35" alt=""></div>
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/turkey.png" class="img-fluid circle"
                            width="35" alt=""></div>
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/spain.png" class="img-fluid circle"
                            width="35" alt=""></div>
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/japan.png" class="img-fluid circle"
                            width="35" alt=""></div>
                        <div class="text-dark text-md fw-medium ps-2">Australian Dollar</div>
                      </a>
                    </li>
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/portugal.png" class="img-fluid circle"
                            width="35" alt=""></div>
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/italy.png" class="img-fluid circle"
                            width="35" alt=""></div>
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/germany.png" class="img-fluid circle"
                            width="35" alt=""></div>
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/france.png" class="img-fluid circle"
                            width="35" alt=""></div>
                    ...
                    <li class="col">
                      <a class="selectCountry" href="#">
                        <div class="d-inline-block"><img src="/src/assets/img/flag/european.png" class="img-fluid circle"
                            width="35" alt=""></div>
